...
namespace Harpia.PrefabBrush
{
    public class PrefabBrushTemplate : ScriptableObject
    {
        ...
        [FormerlySerializedAs("placeOnYZero")] public bool useFakePlaneIfNoHit;
        ...
        private void Init(PrefabBrush model)
        {
            ...
            eraserMask = PB_EraserManager.eraserMask.value;
            eraserTagMask = PB_EraserManager.eraserTagMask.value;
            ...
            makeErasable = model.makeErasableToggle.value;
            addToClippingTest = model.addToClippingCheckToggle.value;
            ...
            useFakePlaneIfNoHit = PB_FakePlaneManger.fakePlaneNoRaycastToggle.value;
            fakePlaneYPosition = PB_FakePlaneManger.fakePlaneYPosField.value;
            ...
            eraserSize = PB_EraserManager.eraserRadiusSlider.value;
            ...
            rotationMode = (PrefabBrush.RotationTypes)model.rotationField.enumField.value;
            ...
            physicsCustomLayer = PB_PhysicsSimulator.customLayerField.value;
            physicsUseCustomLayer = PB_PhysicsSimulator.useCustomLayerToggle.value;
            ...
            //Grid
            snapToGrid = PB_GridSnappingManager.gridSnapToggle.value;
            gridSnapValue = PB_GridSnappingManager.gridSnapValueField.value;
            gridOffset = PB_GridSnappingManager.gridOffsetField.value;
        ...
        private void CloneFrom(PrefabBrushTemplate other)
        {
            ...
            eraserMask = other.eraserMask;
            eraserTagMask = other.eraserTagMask;
            ...
            makeErasable = other.makeErasable;
            addToClippingTest = other.addToClippingTest;
            ...
            deletePhysicsOnly = other.deletePhysicsOnly;
            ...
            physicsUseCustomLayer = other.physicsUseCustomLayer;
            physicsCustomLayer = other.physicsCustomLayer;
            ...
            useFakePlaneIfNoHit = other.useFakePlaneIfNoHit;
            fakePlaneYPosition = other.fakePlaneYPosition;
