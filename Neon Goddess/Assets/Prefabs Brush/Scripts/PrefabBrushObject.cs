...
namespace Harpia.PrefabBrush
{
    ...
    public class PrefabBrushObject : MonoBehaviour
    {
        ...
        public struct RadiusBounds
        {
            ...
            {
                float sqrDistance = (pivot - raycastHitPoint).sqrMagnitude;
        ...
        [SerializeField] [HideInInspector] private MeshCollider addedCollider;

        [SerializeField] [HideInInspector] private Rigidbody addedBody;

        /// <summary>
        ///     Initializes the PrefabBrushObject, called by the painter when a new object is painted.
        /// </summary>
        /// <param name="addPhysicsComponents">
        ...
        public void Init(bool addPhysicsComponents, bool makeErasable, bool clippingTest, int specialLayer)
        {
        ...
        private void DrawBoundsEraser2(Vector3 hitPos, Color boundsColor, float sqrDistance, float eraserRadius)
        {
            ...
            bool v = _cachedRadiusBounds.Intersects(eraserRadius, hitPos);
        ...
        {
            if (brushObjectsCache == null) ForceInit();
        ...
        public static void Dispose(bool removePhysicalComponents = true)
        {
            if (removePhysicalComponents && toDispose != null)
            {
                ...
                toDispose.Clear();
                if (removed) Debug.LogError("[Prefab Brush] Colliders and Rigidbodies removed");
            ...
            foreach (PrefabBrushObject obj in brushObjectsCache)
            {
        ...
        public static void ForceInit()
        {
            ...
            foreach (PrefabBrushObject brushObject in brushObjectsCache) brushObject.InitCachedBounds();
        }
